#pragma once
#include"AViewStudents.h"
#include"AAddStudent.h"
#include"AUpdateStudent.h"
#include"ARemoveStudent.h"
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Text = L"View Student";
...
#pragma endregion
	...
	{
		AAddStudent^ A = gcnew AAddStudent();
		A->ShowDialog();
	}
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e)
	{
		AViewStudents^ A = gcnew AViewStudents();
		A->ShowDialog();
	}
	
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e)
{
	AUpdateStudent^ A = gcnew AUpdateStudent();
	A->ShowDialog();
}
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e)
{
	ARemoveStudent^ A = gcnew ARemoveStudent();
	A->ShowDialog();
}
};
};
