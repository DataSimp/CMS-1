...
namespace CMSProject {
	...
	/// <summary>
	/// Summary for AViewTeacher
	/// </summary>
	public ref class AViewTeacher : public System::Windows::Forms::Form
	{
	public:
		AViewTeacher(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->listBox1->Size = System::Drawing::Size(120, 433);
			this->listBox1->TabIndex = 0;
			this->listBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &AViewTeacher::listBox1_SelectedIndexChanged);
			// 
			// label14
			// 
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(160, 433);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(75, 23);
			this->button3->TabIndex = 134;
			this->button3->Text = L"Refresh";
			this->button3->UseVisualStyleBackColor = true;
			this->button3->Click += gcnew System::EventHandler(this, &AViewTeacher::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &AViewTeacher::button2_Click);
			// 
			// textBox2
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &AViewTeacher::button1_Click);
			// 
			// comboBox2
			// 
			...
			this->ClientSize = System::Drawing::Size(765, 468);
			...
			this->Name = L"AViewTeacher";
			this->Text = L"AViewTeacher";
			this->Load += gcnew System::EventHandler(this, &AViewTeacher::AViewTeacher_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void AViewTeacher_Load(System::Object^ sender, System::EventArgs^ e) 
	{
