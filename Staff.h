#pragma once
#include"AAddStaff.h"
#include"AViewStaff.h"
#include"AUpdateStaff.h"
#include"ARemoveStaff.h"
...
#pragma endregion
	...
	{
		AAddStaff^ AAS = gcnew AAddStaff();
		AAS->ShowDialog();
	}
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e)
	{
		AViewStaff^ AVS = gcnew AViewStaff();
		AVS->ShowDialog();
	}
	private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e)
	{
		AUpdateStaff^ A = gcnew AUpdateStaff();
		A->ShowDialog();
	}
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e)
{
	ARemoveStaff^ A = gcnew ARemoveStaff();
	A->ShowDialog();
}
};
}
