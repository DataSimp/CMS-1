...
namespace CMSProject {
	...
	/// <summary>
	/// Summary for TChangePassword
	/// </summary>
	public ref class TChangePassword : public System::Windows::Forms::Form
	{
	public:
		String^ Username;
		TChangePassword(String^ A)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(296, 161);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 20;
			this->button1->Text = L"Change";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &TChangePassword::button1_Click);
			// 
			// textBox3
			// 
			...
			this->textBox3->Location = System::Drawing::Point(216, 107);
			...
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Calibri", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox2->Location = System::Drawing::Point(216, 70);
			...
			this->ClientSize = System::Drawing::Size(386, 197);
			...
			this->Name = L"TChangePassword";
			this->Text = L"TChangePassword";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		MySqlCommand^ CommandCMSProject = gcnew MySqlCommand("select *from cmsproject.loginteacher where UserName='" + Username + "';", ConnectCMSProject);
		try
		{
			...
			while (ReadCMSProject->Read())
			{
				...
				if (CP == CP1)
				{
					...
					if (NP == CP)
					{
						...
						MySqlConnection^ ConnectCMSProject = gcnew MySqlConnection(ConnectCMSProjectString);
						MySqlDataReader^ ReadCMSProject;
						MySqlCommand^ CommandCMSProject = gcnew MySqlCommand("Update cmsproject.loginteacher set Password='" + this->textBox2->Text + "' where UserName='" + Username + "';", ConnectCMSProject);
						try
						{
							ConnectCMSProject->Open();
							ReadCMSProject = CommandCMSProject->ExecuteReader();
